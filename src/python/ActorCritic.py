...
class ActorCriticNetwork(nn.Module):
    def __init__(self, agent_info_dim, num_items, num_blocks, num_entities):
        ...
        self.item_transformer = MinecraftTransformer(66)
        self.block_transformer = MinecraftTransformer(67)
        self.entity_transformer = MinecraftTransformer(67)

        obs_space_size = agent_info_dim + 66 + 67 + 67
